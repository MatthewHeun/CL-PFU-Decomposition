---
title: "machine_effiency_example"
...
```{r}
create_plot <- function(tibble_data) {
  ggplot2::ggplot(tibble_data, ggplot2::aes(x = Year, y = eta_i)) +
    ggplot2::geom_line() 
}
eta_i_graphs <- nested_eta_i_data |> 
  dplyr::mutate(
    plots = purrr::map(year_eta_i, create_plot)
  )
```
