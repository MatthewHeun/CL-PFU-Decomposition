...
- [ ] EA: Send code that looked at GWh data to Matt.
- [ ] MKH: Build data frames of GWh IEA data.
- [ ] MKH: Run new function across GWh data. Look for mismatches.
...
- [ ] ZG: Look for old code that uses GWhr data to distribute fossil fuel
